...
const SolarPredevelopmentDashboard = () => {
  ...
  // Define chapters for Solar Predevelopment
  const chapters = [
    {
    ...
    {
      id: "land-leasing-activities",
      name: "Land Leasing and Evacuation Capacity Reservation",
      shortName: "Land Activities"
    },
    {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Solar Predevelopment Certification...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">Solar Predevelopment</h1>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <PlaybookCertification
            ...
            playbookName="Solar Predevelopment"
            chapters={chapters}
          />
        </div>
      </main>
